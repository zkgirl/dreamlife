        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-white/10 px-6 py-4 bg-gradient-to-r from-[#34495e] to-[#2c3e50]">
            <div>
              ...
              <p className="text-[#92c9ad] text-sm mt-1">
          ...
          {/* Stats Display */}
          <div className="px-6 py-4 bg-[#34495e]/50 border-b border-white/10">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-blue-400">psychology</span>
                <span className="text-white font-semibold">Your Smarts: {stats.smarts}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-yellow-400">school</span>
                <span className="text-white font-semibold">Current Age: {stats.age}</span>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className={`text-sm font-semibold ${getDifficultyColor(major.difficulty)}`}>
                          {major.difficulty}
                        </p>
                      </div>
                      {isSelected && (
                    ...
                    {/* Description */}
                    <p className="text-gray-300 text-sm mb-4">{major.description}</p>
